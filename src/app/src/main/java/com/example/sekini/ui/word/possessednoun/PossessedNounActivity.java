...
import com.example.sekini.databinding.ActivityPossessedNounBinding;
import com.example.sekini.ui.dictionary.dic.EmptyDicViewModel;
import com.example.sekini.ui.word.generic.GenericViewModel;
import com.example.sekini.ui.word.generic.IGenericNavigator;
...
public class PossessedNounActivity extends BaseActivity<ActivityPossessedNounBinding, PossessedNounViewModel>
    ...
    public static void start(Context context, int sekaniRootId) {
        Intent intent = new Intent(context, PossessedNounActivity.class);
    ...
    public int getLayoutId() {
        return R.layout.activity_possessed_noun;
    }
